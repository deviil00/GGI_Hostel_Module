...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        if User.objects.filter(username='admin1').exists():
            ...
            return
        u = User.objects.create_user(username='admin1', password='Admin@1234')
        u.role = 'superadmin'
        u.name = 'Admin 1'
        u.is_staff = True
        u.is_superuser = True
        u.save()
        self.stdout.write(self.style.SUCCESS('Admin 1 account created. username=admin1 password=Admin@1234'))
